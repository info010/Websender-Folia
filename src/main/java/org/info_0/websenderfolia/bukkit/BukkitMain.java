...
import org.info_0.websenderfolia.shared.SocketServer;
...
public class BukkitMain extends JavaPlugin implements Listener{
    ...
    public static boolean sendCommand(String command){
        scheduler.scheduleSyncDelayedTask(() -> Bukkit.getServer().dispatchCommand(Bukkit.getConsoleSender(), command));
        return true;
    }
